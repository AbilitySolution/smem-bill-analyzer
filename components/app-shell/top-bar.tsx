...
const DESTINATIONS: Dest[] = [
  ...
  { label: "Analyse", href: "/analyses?vue=conso", hint: "Consommation : graphiques kWh / € / c€", icon: Gauge },
  { label: "Couverture", href: "/analyses?vue=couverture", hint: "Couverture de facturation par site ou commune", icon: Gauge },
