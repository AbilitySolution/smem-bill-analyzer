...
const DESTINATIONS: Dest[] = [
  ...
  { label: "Analyse", href: "/analyses/consommation", hint: "Consommation : graphiques kWh / € / c€", icon: Gauge },
  { label: "Couverture", href: "/analyses/couverture", hint: "Couverture de facturation par site ou commune", icon: Gauge },
