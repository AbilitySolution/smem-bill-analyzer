...
export function EditableField({
  ...
  return (
    <div className="group flex items-center justify-between gap-2 rounded-md px-2 py-1.5 transition-colors hover:bg-[#ffedd5]">
      <span className="text-xs font-medium text-[var(--kn-text-muted)]">{label}</span>
      {editing ? (
        <div className="flex items-center gap-1">
          <input
            ...
            className="h-7 w-32 rounded-md border border-[var(--kn-text)]/25 px-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#f97316]"
          />
