...
|---|---|---|---|
| −2 | `20260816190000_communes_creation_down.sql` | Retire `archived` / `slug`, remet `code_insee` à NULL et facultatif, restaure les coordonnées d'avant SCRUM-14 | 🟠 Partiel — perd l'état d'archivage et le `code_insee` des communes créées depuis, et **réintroduit des coordonnées fausses de plus de 10 km** sur Case Pilote, Ducos et Le Marigot |
