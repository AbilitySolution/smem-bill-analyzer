// Sanitise les erreurs du fournisseur de modèle avant qu'elles n'atteignent
// une colonne lue par le frontend (document_jobs.last_error, document_batches.last_error).
// Le message brut (avec détails du fournisseur) reste disponible côté serveur via `logMessage`
// pour le débogage (console.error), mais ne doit jamais être renvoyé tel quel au client.
...
// Point d'entrée unique : à appeler dans chaque catch avant d'écrire dans une
// colonne last_error ou de renvoyer une erreur au client.
