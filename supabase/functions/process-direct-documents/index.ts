...
async function extractInvoice(job: DocumentJob, supabase: ReturnType<typeof createClient>, apiKey: string) {
  ...
  return { extraction: toolUse.input, usage: message.usage ?? null, fileId };
}
