    ...
    <div className="mx-auto max-w-3xl px-6 py-10">
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-2">
          <button type="button" disabled={inspecting || submitting} onClick={() => inputRef.current?.click()} className="flex items-center gap-1.5 rounded-lg border border-[var(--kn-border)] bg-white px-3 py-2 text-xs font-semibold disabled:opacity-50">
            <Archive className="size-4" />Fichiers ou ZIP
          </button>
          <button type="button" disabled={inspecting || submitting} onClick={() => folderInputRef.current?.click()} className="flex items-center gap-1.5 rounded-lg border border-[var(--kn-border)] bg-white px-3 py-2 text-xs font-semibold disabled:opacity-50">
